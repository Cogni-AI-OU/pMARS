...
warrior_dir = os.path.normpath(os.path.join(BASE_DIR, '../../../warriors/tournaments/maniacs1998/round1'))
warriors = ['bezzi.red', 'edgar.red', 'karonen.red', 'guenzel.red', 'macrae.red', 'moore.red']

print("Simulating Redcode Maniacs Tournament Round 1 (Deterministic Subset)...")
...
if winner == 'guenzel.red':
    print("SUCCESS: Guenzel is the winner in this subset, matching regression fixture expectation!")
else:
    print(f"NOTE: Simulated winner is {winner}. Expected guenzel.red for this subset.")

assert winner == 'guenzel.red', sorted_scores
