...
warrior_dir = os.path.normpath(os.path.join(BASE_DIR, '../../../warriors/tournaments/maniacs1998/round3'))
warriors = ['macrae.red', 'kline.red', 'moore.red', 'bezzi.red']

print("Simulating Redcode Maniacs Tournament Round 3 (Deterministic Subset)...")
...
# Since they are all the same code for now, results should be ties
if winner == 'macrae.red':
    print("SUCCESS: Macrae is the winner (by alphabetical/tie-break) in this subset, matching regression fixture expectation!")
else:
