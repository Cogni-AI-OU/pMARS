...
A **quickscan** is an unrolled 2c scan loop which rapidly scans a series of locations in an attempt to detect and attack the opponent within the first few cycles before it has chance to boot away.

## Modern Quickscan (Q^4 scan)
...
Source: [corewar.co.uk/quickscan.htm](https://corewar.co.uk/quickscan.htm)
