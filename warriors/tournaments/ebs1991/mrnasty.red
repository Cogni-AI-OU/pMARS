...
;                                       bombing routine
           add @offsetno, target
           jmp start
five       dat #0, #0-1              ; this is the "zero" bomb -- actually
...
jumploc    dat #0,#0-2               ; jump pointer for the end of the world
incoming   spl 1, 0                    ; prisoner parthenogenesis!
           mov five, <thrtarg       ; prisoner "zero" bombing
           jmp -2, 0                   ; make more inmates & make 'em work!
offsetno   dat #0,#7
           dat #0-23, #23
           dat #0-12, #12
           dat #0-4, #4
