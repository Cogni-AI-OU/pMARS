...
;
LEFTCLAW DAT    <0, <0          ; POINTER TO FIRST ATTACK POSITION

RIGHTCLAW DAT    <0, <2         ; POINTER TO SECOND ATTACK POSITION

HOWFAR   DAT    <0, <63         ; HOW FAR TO ATTACK BEFORE RESETING

HOWMANY  DAT    <0, <18         ; HOW MANY TIMES TO ATTACK

STONE    SPL    STONE, 0        ; STOP AN ENEMY IN IT'S TRACKS

CLAW     DAT    <0, <0          ; KILL AN ENEMY
...
GOBBLE   MOV    CLAW, <CLAW     ; CLAW AN ENEMY
        ...
        JMP    GOBBLE, 0        ; CONTINUE CLAWING

LEFTEYE  DAT    <0, <3          ; THIRD ATTACK POSITION

RIGHTEYE DAT    <0, <4          ; FOURTH ATTACK POSITION
