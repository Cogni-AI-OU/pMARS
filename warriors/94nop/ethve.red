...
; to-improve:	Use Q^4
;		optimize clear's location
;		mov/sub/mov in the stone
;		GATE equ >3..., it is too close
;		launch stone, clear and ipump
;		try to reduce BOOT code size
;		send 4/5.. procs to the SPL# of the stone
;		try to use SoV's Imp-pump, ordering processes carefully
;		more spacing between instructions in the initial structure
;		compare with using 7pt imps, optimizing ST_LOC, so the imp-pump is killed later
